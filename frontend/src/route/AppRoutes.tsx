...
import { PeerServerRoom } from '../components/peer/PeerServerRoom'
...
const SpeakingHub = lazy(() => import('../pages/SpeakingHub').then((m) => ({ default: m.SpeakingHub })))
const SpeakingSolo = lazy(() => import('../pages/Speaking').then((m) => ({ default: m.Speaking })))
...
const PeerInviteJoin = lazy(() => import('../pages/PeerInviteJoin').then((m) => ({ default: m.PeerInviteJoin })))
...
function PeerServerRoomRoute() {
  const { sessionId = '' } = useParams()
  return <PeerServerRoom sessionId={sessionId} />
}
    ...
    <Suspense fallback={<RouteLoadingSpinner />}>
      <Routes>
        ...
        >
          ...
          <Route path={ROUTES.SPEAKING} element={<SpeakingHub />} />
          <Route path={ROUTES.SPEAKING_SOLO} element={<SpeakingSolo />} />
          ...
          <Route path={ROUTES.PEER_JOIN} element={<PeerInviteJoin />} />
          <Route path={ROUTES.PEER_ROOM_SESSION} element={<PeerServerRoomRoute />} />
